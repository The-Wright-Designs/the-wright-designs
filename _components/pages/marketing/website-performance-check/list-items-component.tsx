...
const ListItemsComponent = () => {
  return (
    <section className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1 mt-5 desktopSmall:mt-0">
      ...
      <Button
        url="/assets/website-performance-check/example-website-performance-report.pdf"
        buttonColor="blue"
      ...
      <div className="mt-5 desktopSmall:grid grid-cols-[1.25fr_1fr] gap-10 desktopSmall:h-[250px] desktop:hidden">
        ...
        <div className="hidden relative rounded-lg overflow-hidden shadow-md desktopSmall:block desktopSmall:aspect-auto">
          <Image
            src="/assets/images/website-performance-check/rwerg089-0j4otgwrb.png"
            alt="A web designer and client going through a website performance report"
            fill
