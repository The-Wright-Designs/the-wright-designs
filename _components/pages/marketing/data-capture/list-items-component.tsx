...
const features = [
  ...
  {
    title: "Keep Your Loyalty Program Honest",
    description:
      "Paper cards are easy to manipulate and free coffees are easy to hand out under the table. Go digital to make sure it's all being tracked and used correctly.",
    icon: (
      <svg
        viewBox="0 0 32 32"
        fill="none"
      ...
      >
        <path
          d="M16 3L5 8V15.4C5 21.6 9.7 27.4 16 29C22.3 27.4 27 21.6 27 15.4V8L16 3ZM12 15.5L14.8 18.3L20.4 12.7"
          className="stroke-white desktopSmall:stroke-pink"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
...
const ListItemsComponent = () => {
  return (
    <section className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1 mt-5 desktop:mt-0">
      ...
      <div className="mt-5 desktopSmall:grid grid-cols-[1.25fr_1fr] gap-10 desktopSmall:h-[250px] desktop:hidden">
        ...
        <div className="hidden relative aspect-square rounded-lg overflow-hidden shadow-md desktopSmall:block desktopSmall:aspect-auto">
          <Image
            src="/assets/images/data-capture/rwh564ehgr.png"
            alt="A business owner and customer scanning a loyalty QR code at checkout"
            fill
