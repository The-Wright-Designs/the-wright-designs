...
const SocialIcons = ({ cssClasses, beige }: Props) => {
  return (
    <ul className={classNames("flex gap-5 tablet:gap-3", cssClasses)}>
      <li>
        <Link
        ...
        >
          <svg
            ...
            className="size-7 tablet:size-5.5"
          >
            <path
